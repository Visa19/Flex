        ...
        <div class="grid-container">
            ...
            <div class="dashboard">
                <div class="panel rice-panel">
                    ...
                    <a href="AdminRiceManage.php" id="Textdecoration"><h2 style="color: #E88F2A;">Rice</h2></a>
                </div>
                <div class="panel curry-panel">
                    <i class="fas fa-pepper-hot panel-icon" style="color: #E88F2A;"></i>
                    <a href="AdminCurryManage.php" id="Textdecoration"><h2 style="color: #E88F2A;">Curry</h2></a>
                </div>
